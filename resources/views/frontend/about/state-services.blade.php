...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('frontend.menu.state_services') }}</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="state-services section">
        <div class="container">
            @if($items->isNotEmpty())
                <div class="row gy-4">
    ...
    <style>
        ...
        [data-theme="dark"] .state-services {
            background: #1a1a1a;
        }
