...
@section('title', 'Карта коррупционных рисков')
...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('frontend.menu.corruption_risk_map') }}</li>
                </ol>
            </nav>
        </div>
    </section>

    <!-- Corruption Risk Map Section -->
    <section class="corruption-risk-map section">
        <div class="container">
            @if($maps->isNotEmpty())
                <div class="row">
                    <div class="col-12">
    ...
    <style>
        ...
        [data-theme="dark"] .corruption-risk-map {
            background: #1a1a1a;
        }
