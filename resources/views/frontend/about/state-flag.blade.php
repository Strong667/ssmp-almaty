...
@section('title', 'Государственный Флаг')
...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('frontend.menu.state_flag') }}</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <!-- State Flag Section -->
    <section class="state-flag section">
        <div class="container">
            @if($item)
                <div class="row">
                    <div class="col-12">
                        <div class="symbol-card">
                            @if($item->image_url)
                                <div class="symbol-image-wrapper">
                                    <img src="{{ $item->image_url }}" alt="Государственный Флаг" class="symbol-image">
                                </div>
                            @endif
