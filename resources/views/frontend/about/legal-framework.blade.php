...
@section('title', 'Нормативно-правовая база')
...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> >> {{ __('frontend.menu.legal_framework') }}</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="legal-framework section">
        <div class="container">
            @if($items->isNotEmpty())
                <div class="row gy-4">
    ...
    <style>
        ...
        [data-theme="dark"] .legal-framework {
            background: #1a1a1a;
        }
