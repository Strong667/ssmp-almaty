...
namespace App\MoonShine\Resources\RegistryOfStateServices;
...
class RegistryOfStateServicesResource extends ModelResource
{
    protected string $model = RegistryOfStateServices::class;
    protected string $title = 'Реестр государственных услуг';
