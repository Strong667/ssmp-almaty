...
namespace App\MoonShine\Resources\CorruptionRiskPosition;
...
class CorruptionRiskPositionResource extends ModelResource
{
    protected string $model = CorruptionRiskPosition::class;
    protected string $title = 'Должности, подверженные коррупционным рискам';
