...
namespace App\MoonShine\Resources\InternalRegulations;
...
class InternalRegulationsResource extends ModelResource
{
    protected string $model = InternalRegulations::class;
    protected string $title = 'Внутренние НПА';
