...
#[SkipMenu]
class StateServicesPage extends Page
{
    ...
    public function getBreadcrumbs(): array
    {
        return [
            '/' => 'Главная',
            '/about/state-services' => $this->getTitle()
        ];
    }
    ...
    protected function components(): iterable
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            $containerComponents[] = Box::make('Государственные услуги', [
        ...
        return [
            Box::make('Государственные услуги', $containerComponents),
        ];
    }
}
