...
#[SkipMenu]
class StateServiceStandardsPage extends Page
{
    protected ?string $layout = GuestLayout::class;

    public function getTitle(): string
    {
        return 'Стандарты государственных услуг';
    }
    ...
    public function getBreadcrumbs(): array
    {
        return [
            '/' => 'Главная',
            '/about/state-service-standards' => $this->getTitle()
        ];
    }
    ...
    protected function components(): iterable
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            $containerComponents[] = Box::make('Стандарты государственных услуг', [
        ...
        return [
            Box::make('Стандарты государственных услуг', $containerComponents),
        ];
    }
}
