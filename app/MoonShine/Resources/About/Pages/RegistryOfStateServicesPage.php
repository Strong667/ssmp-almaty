...
#[SkipMenu]
class RegistryOfStateServicesPage extends Page
{
    protected ?string $layout = GuestLayout::class;

    public function getTitle(): string
    {
        return 'Реестр государственных услуг';
    }
    ...
    public function getBreadcrumbs(): array
    {
        return [
            '/' => 'Главная',
            '/about/registry-of-state-services' => $this->getTitle()
        ];
    }
    ...
    protected function components(): iterable
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            $containerComponents[] = Box::make('Реестр государственных услуг', [
        ...
        return [
            Box::make('Реестр государственных услуг', $containerComponents),
        ];
    }
}
