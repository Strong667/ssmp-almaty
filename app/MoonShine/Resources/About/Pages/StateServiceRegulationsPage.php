...
#[SkipMenu]
class StateServiceRegulationsPage extends Page
{
    protected ?string $layout = GuestLayout::class;

    public function getTitle(): string
    {
        return 'Регламенты государственных услуг';
    }
    ...
    public function getBreadcrumbs(): array
    {
        return [
            '/' => 'Главная',
            '/about/state-service-regulations' => $this->getTitle()
        ];
    }
    ...
    protected function components(): iterable
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            $containerComponents[] = Box::make('Регламенты государственных услуг', [
        ...
        return [
            Box::make('Регламенты государственных услуг', $containerComponents),
        ];
    }
}
