        ...
        return TopBar::make([
            ...
            Fragment::make([
                ...
                Dropdown::make()
                    ...
                    ->placement('bottom-start'),
                // Дропдаун меню "Государственные услуги"
                Dropdown::make()
                    ->toggler(
                        '<div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 0.75rem; border-radius: 0.375rem; transition: all 0.2s; ' .
                        (in_array(Route::currentRouteName() ?? '', ['about.registry-of-state-services', 'about.state-service-standards', 'about.state-service-regulations', 'about.state-services']) ? 'background-color: rgba(139, 92, 246, 0.1); color: rgb(139, 92, 246);' : '') .
                        '">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 1rem; height: 1rem;">
                    ...
                    ->items([
                        Link::make(route('about.state-services'), 'Государственные услуги')
                            ->icon('document'),
                        Link::make(route('about.registry-of-state-services'), 'Реестр государственных услуг')
                            ->icon('document-duplicate'),
                        Link::make(route('about.state-service-standards'), 'Стандарты государственных услуг')
                            ->icon('document-check'),
                        Link::make(route('about.state-service-regulations'), 'Регламенты государственных услуг')
                            ->icon('document-text'),
                    ])
                    ->placement('bottom-start'),
                // Дропдаун меню "Государственные символы"
                Dropdown::make()
                    ->toggler(
                        '<div style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 0.75rem; border-radius: 0.375rem; transition: all 0.2s; ' .
                        (in_array(Route::currentRouteName() ?? '', ['about.state-flag', 'about.state-emblem', 'about.state-anthem']) ? 'background-color: rgba(139, 92, 246, 0.1); color: rgb(139, 92, 246);' : '') .
                        '">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 1rem; height: 1rem;">
                    ...
                    ->items([
                        Link::make(route('about.state-flag'), 'Государственный Флаг')
                            ->icon('flag'),
                        Link::make(route('about.state-emblem'), 'Государственный Герб')
                            ->icon('shield-check'),
                        Link::make(route('about.state-anthem'), 'Государственный Гимн')
                            ->icon('speaker-wave'),
                    ])
                    ->placement('bottom-start'),
